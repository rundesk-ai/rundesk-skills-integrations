...
- `jira` - projects, issues, epics, boards, sprints, backlog views, viewable comments, attachment metadata/downloads, and guarded issue creation, editing, commenting, epic/sprint assignment, deletion, and one-file uploads.
